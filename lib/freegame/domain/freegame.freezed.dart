...
class _$_FreeGames implements _FreeGames {
  ...
  @override
  String toString() {
    return 'FreeGames(id: $id, title: $title, thumbnail: $thumbnail, shortDescription: $shortDescription, description: $description, gameUrl: $gameUrl, genre: $genre, platform: $platform, publisher: $publisher, developer: $developer, releaseDate: $releaseDate, freetogameProfileUrl: $freetogameProfileUrl)';
  }
...
abstract class _FreeGames implements FreeGames {
  const factory _FreeGames(
      ...
      @JsonKey(name: 'release_date')
          final DateTime? releaseDate,
      @JsonKey(name: 'freetogame_profile_url', defaultValue: 'N/A')
          final String? freetogameProfileUrl}) = _$_FreeGames;
